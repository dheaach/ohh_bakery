...
<div class="container">
	<div class="row" style="margin-bottom: 0px!important;">
		<div class="col-12" style="margin-bottom: 0px!important;">
			<p style="margin-bottom: 0px;font-size: 24px;"><b>FORMULA BAHAN BAKU</b></p>
			<hr>	
		</div>
	</div>
	<?php
	...
	<table style="width:80%; border-spacing: 0px;">
		<tr>
			...
			<th style="border-bottom: 1px solid black;border-top: 1px solid black;padding:3px;width:67%;">Nama Barang</th>
			<th style="border-bottom: 1px solid black;border-top: 1px solid black;padding:3px;text-align: right;width:8px;" colspan="2">Qty Pemakaian</th>
		</tr>
		<?php
			$no = 0;
			$tot = 0;
		...
		<tr>
			...
			<td style="padding:3px;text-align: right;"><?php echo $det->qty_satuan;?></td>
			<td style="padding:3px;text-align: left;"><?php echo $satuan;?></td>
		</tr>
		<?php
				}
			}
		...
		<tr>
			<td colspan="2" style="padding:3px;text-align: right;">Total</td>
			<td style="padding:3px;text-align: right;"><?php echo $tot;?></td>
			<td></td>
		</tr>
	</table>
</div>
