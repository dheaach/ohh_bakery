var EcommerceProductsEdit = function () {
    ...
    var handleImages = function() {
        ...
        var uploader = new plupload.Uploader({
            ...
            url : BASE_URL+"assets/plugins/plupload/examples/upload.php",
            ...
            // Flash settings
            flash_swf_url : BASE_URL+'assets/plugins/plupload/js/Moxie.swf',
     
            // Silverlight settings
            silverlight_xap_url : BASE_URL+'assets/plugins/plupload/js/Moxie.xap',             
    ...
    var handleReviews = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": BASE_URL+"demo/ecommerce_product_reviews.php", // ajax source
                },
    ...
    var handleHistory = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": BASE_URL+"demo/ecommerce_product_history.php", // ajax source
                },
                "columnDefs": [{ // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'orderable': true,
                    'targets': [0]
